                ...
                <div className={"row justify-content-center"}>
                    ...
                    <div className={"card col-lg-3 m-1 pointit"}>
                        <div className={"card-body"}>
                            ...
                            <span className={"fas fa-hospital-alt m-1"}>  </span>List of Scheduled Appointments
                            </p>
                        </div>
                    ...
                    <div className={"card col-lg-3 m-1 pointit"}>
                        <div className={"card-body"}>
                            ...
                            <span className={"fas fa-microscope m-1"}></span>  See Requested Appointments
                            </p>
                        </div>
                    </div>
                    ...
                    <div className={"card col-lg-3 m-1 pointit"}>
                        <div className={"card-body"}>
                            ...
                            <span className={"fas fa-plus-circle m-1"}></span>See Finalised Appointments
                            </p>
                        </div>
                </div>
